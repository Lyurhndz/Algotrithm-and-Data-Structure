...
public class StudentQueueMain7 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        StudentQueue7 queue = new StudentQueue7(5);
        int choice;
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    Student7 std = new Student7(nim, name, studyProgram,
                            className);
                    queue.enqueue(std);
                    break;
                case 2:
                    Student7 studentBeingServed = queue.dequeue();
